...
document.getElementById('submit').onclick = function() {
    if (document.getElementById('answer').value == '10058') {
        firebase.database().ref('question').update({ q3: 1 })
        ...
        var q1icon = document.getElementById('q3').childNodes[1]['firstElementChild'].classList
        q1icon.remove('bi-x')
        q1icon.add('bi-check')
